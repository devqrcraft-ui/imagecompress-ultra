...
const path = 'C:/Users/RUSLAN/Desktop/imagecompress-ultra/src/utils/compressor.ts';

const fixed = `// dynamic import — loaded only when user compresses
...
console.log('DONE: compressor.ts fixed');
