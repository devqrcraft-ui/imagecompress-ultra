...
const schemaData = {
  blogPosting: {
    ...
    "@type": "BlogPosting",
    "mainEntityOfPage": {"@type": "WebPage", "@id": "https://www.compressto20kb.com/blog/best-image-size-for-ebay-listings"},
    "headline": "Image Compression Guide — best image size for ebay listings",
    ...
    "url": "https://www.compressto20kb.com/blog/best-image-size-for-ebay-listings"
  },
  breadcrumb: {
    "@context": "https://schema.org",
    "@type": "BreadcrumbList",
    "itemListElement": [
      ...
      {"@type": "ListItem", "position": 3, "name": "best image size for ebay listings", "item": "https://www.compressto20kb.com/blog/best-image-size-for-ebay-listings"}
    ]
  }
};
  ...
  return(
    <div style={{minHeight:'100vh',background:'#0f172a',color:'white',fontFamily:'system-ui,sans-serif'}}>
      ...
      <div style={{maxWidth:'800px',margin:'0 auto',padding:'48px 16px 24px'}}>
        <div style={{fontSize:'15px',opacity:0.5,marginBottom:'12px'}}><Link href="/blog" style={{color:'inherit',textDecoration:'none'}}>Blog</Link> → eBay Image Guide</div>
