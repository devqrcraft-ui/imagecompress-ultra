...
export const metadata: Metadata = {
  title: 'Best Image Size for eBay Listings 2026 — Boost Your Sales',
  description: 'eBay requires images under 7MB and at least 500px. Get the exact size, format & compression tips — plus compress your eBay photos free in one click.',
