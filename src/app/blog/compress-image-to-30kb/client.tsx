...
const schemaData = {
  blogPosting: {
    ...
    "@type": "BlogPosting",
    "mainEntityOfPage": {"@type": "WebPage", "@id": "https://www.compressto20kb.com/blog/compress-image-to-30kb"},
    "headline": "Image Compression Guide — compress image to 30kb",
    ...
    "url": "https://www.compressto20kb.com/blog/compress-image-to-30kb"
  },
  breadcrumb: {
    "@context": "https://schema.org",
    "@type": "BreadcrumbList",
    "itemListElement": [
      ...
      {"@type": "ListItem", "position": 3, "name": "compress image to 30kb", "item": "https://www.compressto20kb.com/blog/compress-image-to-30kb"}
    ]
  }
};
    ...
    <div style={{ minHeight: '100vh', background: '#0f172a', color: 'white', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 16px 24px' }}>
        ...
        <div style={{ fontSize:'15px', opacity: 0.5, marginBottom: '12px' }}>
          <Link href="/blog" style={{ color: '#818cf8', textDecoration: 'none' }}>Blog</Link> → Compress Images on iPhone
        </div>
