...
const faq=[{"q":"What size should Amazon product images be?","a":"Amazon requires minimum 1000x1000 pixels for zoom, JPEG or PNG format. Main image must have white background. Compress to under 1MB for fast loading."},{"q":"Does Amazon compress images automatically?","a":"Yes, Amazon recompresses uploaded images. Upload high quality originals and pre-compress to under 1MB before uploading."},{"q":"Should I use JPEG or PNG for Amazon listings?","a":"JPEG for product photos, PNG only if your product has transparent background."}];

const schemaData = {
  blogPosting: {
    "@context": "https://schema.org",
    "@type": "BlogPosting",
    "mainEntityOfPage": {"@type": "WebPage", "@id": "https://www.compressto20kb.com/blog/compress-images-for-amazon-seller"},
    "headline": "Image Compression Guide — compress images for amazon seller",
    ...
    "url": "https://www.compressto20kb.com/blog/compress-images-for-amazon-seller"
  },
  breadcrumb: {
    "@context": "https://schema.org",
    "@type": "BreadcrumbList",
    "itemListElement": [
      ...
      {"@type": "ListItem", "position": 3, "name": "compress images for amazon seller", "item": "https://www.compressto20kb.com/blog/compress-images-for-amazon-seller"}
    ]
  }
};
  ...
  return(
    <div style={{minHeight:'100vh',background:'linear-gradient(135deg,#0f0c29,#302b63,#24243e)',color:'white',fontFamily:'system-ui,sans-serif'}}>
      ...
      <div style={{maxWidth:'800px',margin:'0 auto',padding:'48px 16px 24px'}}>
        <div style={{fontSize:'15px',opacity:0.5,marginBottom:'12px'}}><Link href="/blog" style={{color:'inherit',textDecoration:'none'}}>Blog</Link> → Compress Images for Amazon Sellers 2025</div>
        ...
        <h1 style={{fontSize:'clamp(24px,4vw,40px)',fontWeight:900,margin:'0 0 16px',lineHeight:1.2}}>Compress Images for Amazon Sellers 2025<br/><span style={{color:'#818cf8'}}>Product Listings · A+ Content · Main Image</span></h1>
        ...
        <p style={{fontSize:'16px',opacity:0.65,marginBottom:'32px',lineHeight:1.7}}>Amazon product images must meet strict requirements. Properly compressed images load faster, rank higher, and convert better.</p>
        <div style={{background:'rgba(251,191,36,0.1)',border:'1px solid rgba(251,191,36,0.3)',borderRadius:'12px',padding:'16px 20px',marginBottom:'32px'}}>
          <strong style={{color:'#fde68a'}}>📋 Amazon Requirements:</strong>
          <span style={{fontSize:'14px',opacity:0.85}}> JPEG or PNG · 1000×1000 px minimum · Under 10MB · White background for main image</span>
        </div>
