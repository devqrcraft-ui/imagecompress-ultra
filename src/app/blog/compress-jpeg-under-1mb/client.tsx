...
const faq=[{"q":"How do I compress a JPEG to under 1MB?","a":"Upload your JPEG, switch to Exact KB Mode, type 900, select JPEG format, and click Compress."},{"q":"Will compressing JPEG reduce quality?","a":"At quality 80-85%, compression is visually indistinguishable from the original."},{"q":"Can I compress multiple JPEGs at once?","a":"Yes. Upload up to 50 JPEG files at once and download them all as a ZIP archive."}];

const schemaData = {
  blogPosting: {
    "@context": "https://schema.org",
    "@type": "BlogPosting",
    "mainEntityOfPage": {"@type": "WebPage", "@id": "https://www.compressto20kb.com/blog/compress-jpeg-under-1mb"},
    "headline": "Image Compression Guide — compress jpeg under 1mb",
    ...
    "url": "https://www.compressto20kb.com/blog/compress-jpeg-under-1mb"
  },
  breadcrumb: {
    "@context": "https://schema.org",
    "@type": "BreadcrumbList",
    "itemListElement": [
      ...
      {"@type": "ListItem", "position": 3, "name": "compress jpeg under 1mb", "item": "https://www.compressto20kb.com/blog/compress-jpeg-under-1mb"}
    ]
  }
};
  ...
  return(
    <div style={{minHeight:'100vh',background:'#0f172a',color:'white',fontFamily:'system-ui,sans-serif'}}>
      ...
      <div style={{maxWidth:'800px',margin:'0 auto',padding:'48px 16px 24px'}}>
        <div style={{fontSize:'15px',opacity:0.5,marginBottom:'12px'}}><Link href="/blog" style={{color:'inherit',textDecoration:'none'}}>Blog</Link> → Compress JPEG Under 1MB Free Online</div>
        <div style={{display:'inline-block',background:'rgba(99,102,241,0.1)',border:'1px solid rgba(99,102,241,0.3)',borderRadius:'10px',padding:'6px 14px',fontSize:'12px',marginBottom:'16px',color:'#818cf8'}}>📁 JPEG Compression</div>
        <h1 style={{fontSize:'clamp(24px,4vw,40px)',fontWeight:900,margin:'0 0 16px',lineHeight:1.2}}>Compress JPEG Under 1MB Free Online<br/><span style={{color:'#818cf8'}}>Fast · No Upload · 100% Private</span></h1>
        ...
        <p style={{fontSize:'16px',opacity:0.65,marginBottom:'32px',lineHeight:1.7}}>Need to compress a JPEG file under 1MB? Our browser-based tool compresses JPEG images to any target size without uploading to a server.</p>
        <div style={{background:'rgba(99,102,241,0.1)',border:'1px solid rgba(99,102,241,0.3)',borderRadius:'12px',padding:'16px 20px',marginBottom:'32px'}}>
          <strong style={{color:'#818cf8'}}>💡 Pro Tip:</strong>
          <span style={{fontSize:'14px',opacity:0.85}}> Quality 85% in JPEG reduces file size by 60-70% with no visible quality loss.</span>
        </div>
        ...
        <div style={{marginBottom:'40px'}}><CompressorWidget defaultMode="exactkb" defaultTargetKB={900} defaultFormat="jpeg"/></div>
