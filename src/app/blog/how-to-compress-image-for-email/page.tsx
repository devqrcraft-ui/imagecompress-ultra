    ...
    <>
      ...
      <div style={{ maxWidth: '780px', margin: '0 auto', padding: '48px 20px' }}>
        ...
        <ol style={{ paddingLeft: '20px', fontSize: '15px', lineHeight: 2.2, opacity: 0.8 }}>
          <li>Go to <a href='https://compressto20kb.com/compress-for-email' style={{ color: '#818cf8' }}>compressto20kb.com/compress-for-email</a></li>
        ...
        <p style={{ fontSize: '15px', lineHeight: 1.8, opacity: 0.8, marginBottom: '12px' }}>Use the <a href='https://compressto20kb.com/bulk-image-compressor' style={{ color: '#818cf8' }}>bulk image compressor</a> to compress up to 50 images at once and download as a ZIP. This is the fastest way to prepare multiple photos for a single email without going over the attachment limit.</p>
        ...
        <div style={{ background: 'rgba(16,185,129,0.08)', border: '1px solid rgba(16,185,129,0.2)', borderRadius: '12px', padding: '20px', margin: '32px 0', textAlign: 'center' }}>
          ...
          <a href='https://compressto20kb.com/compress-for-email' style={{ display: 'inline-block', background: 'linear-gradient(135deg,#6366f1,#22d3ee)', color: 'white', padding: '12px 28px', borderRadius: '100px', fontWeight: 700, textDecoration: 'none', fontSize: '14px' }}>Compress for Email Free</a>
        </div>
