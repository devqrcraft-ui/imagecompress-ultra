...
const faq=[{"q":"How do images affect Google PageSpeed score?","a":"Images are typically 60-70% of page weight. Large images slow LCP which is a Core Web Vitals metric that directly affects Google rankings."},{"q":"What image format does Google recommend for PageSpeed?","a":"Google recommends WebP and AVIF for web images — they produce 25-50% smaller files than JPEG at equal quality."},{"q":"How small should my hero image be for PageSpeed?","a":"Hero and LCP images should be under 200KB for a good PageSpeed score. Use WebP format at quality 80-85%."}];

const schemaData = {
  blogPosting: {
    "@context": "https://schema.org",
    "@type": "BlogPosting",
    "mainEntityOfPage": {"@type": "WebPage", "@id": "https://www.compressto20kb.com/blog/pagespeed-images"},
    "headline": "Image Compression Guide — pagespeed images",
    ...
    "url": "https://www.compressto20kb.com/blog/pagespeed-images"
  },
  breadcrumb: {
    "@context": "https://schema.org",
    "@type": "BreadcrumbList",
    "itemListElement": [
      ...
      {"@type": "ListItem", "position": 3, "name": "pagespeed images", "item": "https://www.compressto20kb.com/blog/pagespeed-images"}
    ]
  }
};
  ...
  return(
    <div style={{minHeight:'100vh',background:'linear-gradient(135deg,#0f0c29,#302b63,#24243e)',color:'white',fontFamily:'system-ui,sans-serif'}}>
      ...
      <div style={{maxWidth:'800px',margin:'0 auto',padding:'48px 16px 24px'}}>
        <div style={{fontSize:'15px',opacity:0.5,marginBottom:'12px'}}><Link href="/blog" style={{color:'inherit',textDecoration:'none'}}>Blog</Link> → PageSpeed Images — Optimize for Google 2025</div>
        <div style={{display:'inline-block',background:'rgba(52,211,153,0.1)',border:'1px solid rgba(52,211,153,0.3)',borderRadius:'10px',padding:'6px 14px',fontSize:'12px',marginBottom:'16px',color:'#6ee7b7'}}>🚀 PageSpeed</div>
        <h1 style={{fontSize:'clamp(24px,4vw,40px)',fontWeight:900,margin:'0 0 16px',lineHeight:1.2}}>PageSpeed Images — Optimize for Google 2025<br/><span style={{color:'#818cf8'}}>LCP · Core Web Vitals · Rankings</span></h1>
        ...
        <p style={{fontSize:'16px',opacity:0.65,marginBottom:'32px',lineHeight:1.7}}>Google PageSpeed penalizes large images. Here is how to optimize images to improve your PageSpeed score and Google rankings.</p>
        <div style={{background:'rgba(52,211,153,0.1)',border:'1px solid rgba(52,211,153,0.3)',borderRadius:'12px',padding:'16px 20px',marginBottom:'32px'}}>
          <strong style={{color:'#6ee7b7'}}>📋 PageSpeed Target:</strong>
          <span style={{fontSize:'14px',opacity:0.85}}> LCP image under 200KB · All images lazy loaded · WebP format · Proper dimensions</span>
        </div>
