...
export const metadata = {
  title: 'Compress For China Visa — Compress to 20KB | No Upload',
  description: 'Official requirements for Compress For China Visa. Compress your photo to exactly 20KB with high quality. 100% private browser-based tool.',
    ...
    <>
      <div style={{background:'#0f0c29', padding:'40px 20px', textAlign:'center'}}>
        ...
        <p style={{color:'rgba(255,255,255,0.7)', maxWidth:'700px', margin:'0 auto'}}>
          Meet the official <strong>Compress For China Visa</strong> image requirements instantly. 
          ...
          <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'20px', marginTop:'20px'}}>
            ...
            <div style={{background:'rgba(255,255,255,0.03)', padding:'15px', borderRadius:'8px'}}>
              ...
              <ul style={{paddingLeft:'20px', marginTop:'10px', fontSize:'14px', opacity:0.8}}>
                ...
                <li>Lighting: Balanced</li>
                <li>Expression: Neutral, ears visible</li>
              </ul>
            </div>
          </div>
        </div>
