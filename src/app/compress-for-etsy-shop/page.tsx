...
export const metadata = {
  ...
  description: 'Official requirements for Compress For Etsy Shop. Compress your photo to exactly 20KB with high quality. 100% private browser-based tool.',
    ...
    <>
      <div style={{background:'#0f0c29', padding:'40px 20px', textAlign:'center'}}>
        ...
        <p style={{color:'rgba(255,255,255,0.7)', maxWidth:'700px', margin:'0 auto'}}>
          Meet the official <strong>Compress For Etsy Shop</strong> image requirements instantly. 
          ...
          <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'20px', marginTop:'20px'}}>
            <div style={{background:'rgba(255,255,255,0.03)', padding:'15px', borderRadius:'8px'}}>
              ...
              <ul style={{paddingLeft:'20px', marginTop:'10px', fontSize:'14px', opacity:0.8}}>
                ...
                <li>Dimensions: 2000 px wide</li>
              </ul>
            </div>
            <div style={{background:'rgba(255,255,255,0.03)', padding:'15px', borderRadius:'8px'}}>
              <strong>Visual Standards:</strong>
              <ul style={{paddingLeft:'20px', marginTop:'10px', fontSize:'14px', opacity:0.8}}>
                <li>Background: Neutral</li>
                <li>Lighting: Natural</li>
                <li>Expression: High resolution</li>
              </ul>
            </div>
          </div>
        </div>
