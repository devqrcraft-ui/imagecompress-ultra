...
export const metadata: Metadata = {
  ...
  description: 'Compress photo for F-1 US student visa application. Under 240KB, white background, JPEG.',
...
export default function Page() {
  ...
  const faq = [
    { q: 'What are the photo requirements for F-1 Student Visa?', a: 'F-1 student visa photo: JPEG under 240KB, 600×600px, white background. Submit via DS-160 form.' },
    { q: 'How do I compress a photo for F-1 Student Visa?', a: 'Use our free tool above. Select Exact KB Mode, enter 240 as target, download your compressed photo.' },
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg,#0f0c29,#302b63,#24243e)', color: 'white', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 16px 24px' }}>
        ...
        <p style={{ fontSize: '15px', lineHeight: 1.7, opacity: 0.7, marginBottom: '32px' }}>F-1 student visa photo: JPEG under 240KB, 600×600px, white background. Submit via DS-160 form.</p>
