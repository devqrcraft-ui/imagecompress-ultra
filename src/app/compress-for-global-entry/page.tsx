...
export const metadata: Metadata = {
  ...
  description: 'Compress photo for Global Entry or TSA PreCheck application. Under 5MB, white background, JPEG.',
...
export default function Page() {
  const maxDisplay = 5120 >= 1024 ? Math.round(5120/1024)+'MB' : '5120KB';
  const faq = [
    { q: 'What are the photo requirements for Global Entry / TSA PreCheck?', a: 'Global Entry / CBP photo: JPEG or PNG, under 5MB, white or off-white background, taken within 6 months.' },
    { q: 'How do I compress a photo for Global Entry / TSA PreCheck?', a: 'Use our free tool above. Select Exact KB Mode, enter 5120 as target, download your compressed photo.' },
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg,#0f0c29,#302b63,#24243e)', color: 'white', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 16px 24px' }}>
        ...
        <p style={{ fontSize: '15px', lineHeight: 1.7, opacity: 0.7, marginBottom: '32px' }}>Global Entry / CBP photo: JPEG or PNG, under 5MB, white or off-white background, taken within 6 months.</p>
        ...
        <h2 style={{ fontSize: '22px', fontWeight: 700, marginBottom: '16px' }}>FAQ — Global Entry / TSA PreCheck Photo Requirements</h2>
