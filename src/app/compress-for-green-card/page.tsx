...
export const metadata: Metadata = {
  ...
  description: 'Compress photo for Green Card application Form I-485. Under 240KB, white background, JPEG.',
...
export default function Page() {
  ...
  const faq = [
    { q: 'What are the photo requirements for Green Card (Form I-485)?', a: 'Green Card I-485 photo: JPEG, under 240KB, 2×2 inch (600×600px at 300dpi), white background, recent photo.' },
    { q: 'How do I compress a photo for Green Card (Form I-485)?', a: 'Use our free tool above. Select Exact KB Mode, enter 240 as target, download your compressed photo.' },
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg,#0f0c29,#302b63,#24243e)', color: 'white', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 16px 24px' }}>
        ...
        <p style={{ fontSize: '15px', lineHeight: 1.7, opacity: 0.7, marginBottom: '32px' }}>Green Card I-485 photo: JPEG, under 240KB, 2×2 inch (600×600px at 300dpi), white background, recent photo.</p>
        ...
        <h2 style={{ fontSize: '22px', fontWeight: 700, marginBottom: '16px' }}>FAQ — Green Card (Form I-485) Photo Requirements</h2>
