...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/compress-for-greenhouse' },
  keywords: 'compress photo for greenhouse, Greenhouse ATS profile photo size, Greenhouse ATS photo requirements',
};

export default function Page() {
  const faq = [
    { q: 'What size should my Greenhouse ATS profile photo be?', a: 'Greenhouse ATS photo: JPEG or PNG, under 5MB. Professional headshot recommended for job applications.' },
    { q: 'How do I compress my photo for Greenhouse ATS?', a: 'Click the button above, upload your photo, select Exact KB Mode, enter 5120 as target size and download.' },
    { q: 'What format does Greenhouse ATS accept for profile photos?', a: 'JPEG and PNG are accepted. We recommend JPEG for smaller file sizes.' },
  ];
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg,#0f0c29,#302b63,#24243e)', color: 'white', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 16px 24px' }}>
        <h1 style={{ fontSize: 'clamp(26px,4vw,42px)', fontWeight: 900, lineHeight: 1.2, marginBottom: '12px' }}>
          💼 Compress Photo for <span style={{ color: '#818cf8' }}>Greenhouse ATS</span>
        </h1>
        <p style={{ fontSize: '15px', lineHeight: 1.7, opacity: 0.7, marginBottom: '32px' }}>Greenhouse ATS photo: JPEG or PNG, under 5MB. Professional headshot recommended for job applications.</p>
        ...
        <div style={{ background: 'rgba(129,140,248,0.12)', border: '1px solid rgba(129,140,248,0.35)', borderRadius: '14px', padding: '24px', marginBottom: '40px', textAlign: 'center' }}>
          <div style={{ fontSize: '15px', fontWeight: 700, marginBottom: '8px' }}>🎯 Compress for Greenhouse ATS</div>
          <p style={{ fontSize: '13px', opacity: 0.65, marginBottom: '16px' }}>No upload. Files stay on your device.</p>
          <a href={"/?mode=exactkb&target=5120"} style={{ display: 'inline-block', background: 'linear-gradient(135deg,#6366f1,#8b5cf6)', color: 'white', padding: '12px 28px', borderRadius: '100px', fontWeight: 800, fontSize: '14px', textDecoration: 'none' }}>
            ⚡ Compress for Greenhouse ATS
          </a>
        </div>
        <h2 style={{ fontSize: '22px', fontWeight: 700, marginBottom: '16px' }}>FAQ — Greenhouse ATS Photo</h2>
