...
export const metadata = {
  title: 'Compress For India Passport — Compress to 20KB | No Upload',
  description: 'Official requirements for Compress For India Passport. Compress your photo to exactly 20KB with high quality. 100% private browser-based tool.',
    ...
    <>
      <div style={{background:'#0f0c29', padding:'40px 20px', textAlign:'center'}}>
        ...
        <p style={{color:'rgba(255,255,255,0.7)', maxWidth:'700px', margin:'0 auto'}}>
          Meet the official <strong>Compress For India Passport</strong> image requirements instantly. 
