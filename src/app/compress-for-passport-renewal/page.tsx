...
export default function Page() {
  ...
  const faq = [
    { q: 'What are the photo requirements for US Passport Renewal?', a: 'US passport renewal photo: JPEG under 240KB, 600x600px 2x2 inch, white or off-white background, taken within 6 months.' },
    { q: 'How do I compress a photo for US Passport Renewal?', a: 'Click the button above, select Exact KB Mode, enter 240 as target size and download.' },
    ...
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg,#0f0c29,#302b63,#24243e)', color: 'white', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 16px 24px' }}>
        <div style={{ fontSize:'15px', opacity: 0.5, marginBottom: '12px' }}>
          <Link href="/" style={{ color: '#a5b4fc', textDecoration: 'none' }}>Home</Link> {'->'} 🏛️ US Passport Renewal
        </div>
        ...
        <p style={{ fontSize: '15px', lineHeight: 1.7, opacity: 0.7, marginBottom: '32px' }}>US passport renewal photo: JPEG under 240KB, 600x600px 2x2 inch, white or off-white background, taken within 6 months.</p>
        ...
        <div style={{ background: 'rgba(129,140,248,0.12)', border: '1px solid rgba(129,140,248,0.35)', borderRadius: '14px', padding: '24px', marginBottom: '40px', textAlign: 'center' }}>
          ...
          <div style={{ marginTop: '12px', fontSize: '13px', opacity: 0.5 }}>Apply at: <a href="https://travel.state.gov" target="_blank" rel="noopener noreferrer" style={{ color: '#a5b4fc' }}>https://travel.state.gov</a></div>
        </div>
        <h2 style={{ fontSize: '22px', fontWeight: 700, marginBottom: '16px' }}>How to Compress Photo for US Passport Renewal</h2>
        {[
          ...
          { step: '4', title: 'Download and submit', desc: 'Your photo is compressed and ready to upload to your US Passport Renewal application.' },
        ].map(({ step, title, desc }) => (
        ...
        <h2 style={{ fontSize: '22px', fontWeight: 700, margin: '40px 0 16px' }}>FAQ — US Passport Renewal Photo Requirements</h2>
