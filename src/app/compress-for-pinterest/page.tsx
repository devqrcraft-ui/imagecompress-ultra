...
const _faqSchema = {"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is the best image size for Pinterest pins?","acceptedAnswer":{"@type":"Answer","text":"Pinterest recommends a 2:3 aspect ratio — 1000x1500px is ideal. File size should be under 20MB (Pinterest's limit), but for fast loading in feeds, aim for 200-500KB. JPEG works best for photos; PNG for graphics with text."}},{"@type":"Question","name":"How do I compress images for Pinterest without losing quality?","acceptedAnswer":{"@type":"Answer","text":"Upload your pin image, select JPEG format at 85% quality or set Exact KB Mode to 300-500KB, and compress. Pinterest re-compresses uploads, so starting from a well-optimized file keeps your pins sharp in search results and home feeds."}},{"@type":"Question","name":"Does Pinterest accept WebP images?","acceptedAnswer":{"@type":"Answer","text":"Pinterest supports WebP uploads in modern browsers. However, JPEG is safer for cross-platform compatibility. Use JPEG for pins you want to display consistently across all devices and Pinterest apps."}},{"@type":"Question","name":"Will my Pinterest images be uploaded to compress them?","acceptedAnswer":{"@type":"Answer","text":"No. All compression runs locally in your browser. Your images never leave your device."}}]};
...
export default function CompressForPinterestPage() {
  return (
    <main style={{ minHeight: '100vh', background: 'linear-gradient(135deg,#0f0c29,#302b63,#24243e)', color: 'white', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 16px 24px' }}>
        <div style={{ fontSize: '13px', opacity: 0.5, marginBottom: '12px' }}><Link href="/blog" style={{ color: 'inherit', textDecoration: 'none' }}>Blog</Link> → Compress for Pinterest</div>
        <div style={{ display: 'inline-block', background: 'rgba(99,102,241,0.1)', border: '1px solid rgba(99,102,241,0.3)', borderRadius: '10px', padding: '6px 14px', fontSize: '12px', marginBottom: '16px' }}>🆓 Pinterest · Free Tool</div>
        <h1 style={{ fontSize: 'clamp(24px,4vw,40px)', fontWeight: 900, margin: '0 0 16px', lineHeight: 1.2 }}>Compress Images for Pinterest<br/><span style={{ color: '#818cf8' }}>Free, Private & Instant</span></h1>
        <p style={{ fontSize: '16px', opacity: 0.65, marginBottom: '32px', lineHeight: 1.7 }}>Need to compress images for Pinterest? Our free browser-based tool compresses JPEG, PNG, WebP instantly — no upload required, no signup needed. Your files never leave your device.</p>
        ...
        <div style={{ background: 'rgba(99,102,241,0.15)', border: '1px solid rgba(99,102,241,0.3)', borderRadius: '16px', padding: '24px', marginBottom: '32px', textAlign: 'center' }}>
          <p style={{ fontSize: '18px', fontWeight: 700, marginBottom: '12px' }}>Ready to compress for Pinterest?</p>
        ...
        <h2 style={{ fontSize: '20px', fontWeight: 800, marginBottom: '16px' }}>Pinterest Image Requirements</h2>
        ...
        <h2 style={{ fontSize: '20px', fontWeight: 800, marginBottom: '16px' }}>How to Compress Images for Pinterest (3 Steps)</h2>
        <div style={{ display: 'grid', gap: '12px', marginBottom: '32px' }}>
          {[
            { n: '1', t: 'Upload Your Image', d: 'Drag & drop or click to select. Supports JPEG, PNG, WebP, HEIC up to 50MB.' },
            { n: '2', t: 'Set Target Size', d: 'Type your target KB — or use the Pinterest preset for instant optimization.' },
            { n: '3', t: 'Download Compressed File', d: 'Click download. Your optimized image is ready for Pinterest in seconds.' },
          ].map(s => (
        ...
        <h2 style={{ fontSize: '20px', fontWeight: 800, marginBottom: '16px' }}>Why Use CompressTo20KB for Pinterest?</h2>
        ...
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', paddingTop: '24px' }}>
          <h2 style={{ fontSize: '18px', fontWeight: 800, marginBottom: '16px' }}>FAQ — Compress Images for Pinterest</h2>
          {[
            { q: 'Is this tool really free for Pinterest?', a: 'Yes, 100% free. No signup, no subscription, no hidden fees.' },
            ...
            { q: 'How small can I compress images for Pinterest?', a: 'You can compress to any target size — from 5KB to 5MB. Just type your desired file size.' },
          ].map((f, i) => (
        ...
        <div style={{ textAlign: 'center', marginTop: '40px', padding: '32px', background: 'rgba(99,102,241,0.1)', borderRadius: '16px', border: '1px solid rgba(99,102,241,0.2)' }}>
          <h2 style={{ fontSize: '22px', fontWeight: 800, marginBottom: '8px' }}>Start Compressing for Pinterest Now</h2>
