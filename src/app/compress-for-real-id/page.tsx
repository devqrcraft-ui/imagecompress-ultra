...
export default function Page() {
  ...
  const faq = [
    { q: 'What are the photo requirements for REAL ID Application?', a: 'REAL ID photo requirements vary by state. Generally: JPEG, white or light grey background, taken within 6 months, no glasses.' },
    { q: 'How do I compress a photo for REAL ID Application?', a: 'Use our free tool above. Select Exact KB Mode, enter 5120 as target, download your compressed photo.' },
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg,#0f0c29,#302b63,#24243e)', color: 'white', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 16px 24px' }}>
        ...
        <p style={{ fontSize: '15px', lineHeight: 1.7, opacity: 0.7, marginBottom: '32px' }}>REAL ID photo requirements vary by state. Generally: JPEG, white or light grey background, taken within 6 months, no glasses.</p>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(140px,1fr))', gap: '12px', marginBottom: '28px' }}>
          {[
            { label: 'Max File Size', value: maxDisplay, icon: '📦', color: '#4ade80' },
            { label: 'Dimensions', value: '600×750px', icon: '📐', color: '#818cf8' },
        ...
        <div style={{ background: 'rgba(129,140,248,0.12)', border: '1px solid rgba(129,140,248,0.35)', borderRadius: '14px', padding: '24px', marginBottom: '40px', textAlign: 'center' }}>
          ...
          }>Apply at: <a href="" target="_blank" rel="noopener noreferrer" style={{ color: '#a5b4fc' }}></a></div>}
        </div>
