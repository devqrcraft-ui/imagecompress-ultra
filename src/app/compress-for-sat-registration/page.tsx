...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://compressto20kb.com/compress-for-sat-registration' },
  openGraph: { url: 'https://compressto20kb.com/compress-for-sat-registration' },
  keywords: 'compress photo for sat-registration, SAT Registration photo requirements, SAT Registration photo size',
};

export default function Page() {
  const faq = [
    { q: 'What are the photo requirements for SAT Registration?', a: 'SAT registration photo: JPEG, under 240KB, white or off-white background, taken within 6 months. Face must be clearly visible.' },
    { q: 'How do I compress my photo for SAT Registration?', a: 'Click the button above, select Exact KB Mode, enter 240 as target and download your compressed photo.' },
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg,#0f0c29,#302b63,#24243e)', color: 'white', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://compressto20kb.com"},{"@type":"ListItem","position":2,"name":"Compress Photo for SAT Registration","item":"https://compressto20kb.com/compress-for-sat-registration"}]}' }} />
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 16px 24px' }}>
        <h1 style={{ fontSize: 'clamp(26px,4vw,42px)', fontWeight: 900, lineHeight: 1.2, marginBottom: '12px' }}>
          🎓 Compress Photo for <span style={{ color: '#818cf8' }}>SAT Registration</span>
        </h1>
        <p style={{ fontSize: '15px', lineHeight: 1.7, opacity: 0.7, marginBottom: '32px' }}>SAT registration photo: JPEG, under 240KB, white or off-white background, taken within 6 months. Face must be clearly visible.</p>
        <div style={{ background: 'rgba(129,140,248,0.12)', border: '1px solid rgba(129,140,248,0.35)', borderRadius: '14px', padding: '24px', marginBottom: '40px', textAlign: 'center' }}>
          <div style={{ fontSize: '15px', fontWeight: 700, marginBottom: '8px' }}>🎯 Compress for SAT Registration — Under 240KB</div>
          ...
          <a href={"/?mode=exactkb&target=240"} style={{ display: 'inline-block', background: 'linear-gradient(135deg,#6366f1,#8b5cf6)', color: 'white', padding: '12px 28px', borderRadius: '100px', fontWeight: 800, fontSize: '14px', textDecoration: 'none' }}>
            ⚡ Open SAT Registration Photo Compressor
          </a>
        </div>
        <h2 style={{ fontSize: '22px', fontWeight: 700, marginBottom: '16px' }}>FAQ — SAT Registration Photo Requirements</h2>
