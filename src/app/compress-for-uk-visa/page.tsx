...
export const metadata = {
  title: 'UK Visa Photo Compressor — Compress to 50KB | No Upload',
  description: 'Resize and compress UK Visa photo to 50KB.',
    ...
    <>
      <div style={{background:'#0f0c29', padding:'40px 20px', textAlign:'center'}}>
        ...
        <p style={{color:'rgba(255,255,255,0.7)', maxWidth:'700px', margin:'0 auto'}}>
          Optimize your photo for UK Visa Photo Compressor requirements. 
      ...
      <div style={{background:'#0f0c29', padding:'40px 20px', color:'#fff', borderTop:'1px solid rgba(255,255,255,0.1)'}}>
        <div style={{maxWidth:'800px', margin:'0 auto'}}>
          <h2 style={{color:'#a5b4fc'}}>Requirements for UK Visa Photo Compressor</h2>
