...
export const metadata = {
  title: 'US Visa DS-160 Photo Compressor — Compress to 240KB | No Upload',
  description: 'Compress your US Visa photo to under 240KB.',
    ...
    <>
      <div style={{background:'#0f0c29', padding:'40px 20px', textAlign:'center'}}>
        ...
        <p style={{color:'rgba(255,255,255,0.7)', maxWidth:'700px', margin:'0 auto'}}>
          Optimize your photo for US Visa DS-160 Photo Compressor requirements. 
      ...
      <div style={{background:'#0f0c29', padding:'40px 20px', color:'#fff', borderTop:'1px solid rgba(255,255,255,0.1)'}}>
        <div style={{maxWidth:'800px', margin:'0 auto'}}>
          <h2 style={{color:'#a5b4fc'}}>Requirements for US Visa DS-160 Photo Compressor</h2>
