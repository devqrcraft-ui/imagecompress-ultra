...
export default function Page() {
  ...
  const faq = [
    { q: 'What are the photo requirements for USCIS N-400 Citizenship?', a: 'USCIS N-400 photo: JPEG under 240KB, 2x2 inch 600x600px, white background, taken within 30 days.' },
    { q: 'How do I compress a photo for USCIS N-400 Citizenship?', a: 'Click the button above, select Exact KB Mode, enter 240 as target size and download.' },
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg,#0f0c29,#302b63,#24243e)', color: 'white', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.compressto20kb.com"},{"@type":"ListItem","position":2,"name":"Compress Photo for USCIS N-400 Citizenship","item":"https://www.compressto20kb.com/compress-for-uscis-n400"}]}' }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 16px 24px' }}>
        <div style={{ fontSize:'15px', opacity: 0.5, marginBottom: '12px' }}>
          <Link href="/" style={{ color: '#a5b4fc', textDecoration: 'none' }}>Home</Link> {'->'} 🏛️ USCIS N-400 Citizenship
        </div>
        <h1 style={{ fontSize: 'clamp(26px,4vw,42px)', fontWeight: 900, lineHeight: 1.2, marginBottom: '12px' }}>
          🏛️ Compress Photo for <span style={{ color: '#818cf8' }}>USCIS N-400 Citizenship</span>
        </h1>
        <p style={{ fontSize: '15px', lineHeight: 1.7, opacity: 0.7, marginBottom: '32px' }}>USCIS N-400 photo: JPEG under 240KB, 2x2 inch 600x600px, white background, taken within 30 days.</p>
        ...
        <div style={{ background: 'rgba(129,140,248,0.12)', border: '1px solid rgba(129,140,248,0.35)', borderRadius: '14px', padding: '24px', marginBottom: '40px', textAlign: 'center' }}>
          <div style={{ fontSize: '15px', fontWeight: 700, marginBottom: '8px' }}>🎯 Compress to {maxDisplay} — USCIS N-400 Citizenship Ready</div>
          ...
          <a href={`/?mode=exactkb&target=${maxKB}`} style={{ display: 'inline-block', background: 'linear-gradient(135deg,#6366f1,#8b5cf6)', color: 'white', padding: '12px 28px', borderRadius: '100px', fontWeight: 800, fontSize: '14px', textDecoration: 'none' }}>
            ⚡ Open USCIS N-400 Citizenship Photo Compressor
          </a>
          <div style={{ marginTop: '12px', fontSize: '13px', opacity: 0.5 }}>Apply at: <a href="https://www.uscis.gov/n-400" target="_blank" rel="noopener noreferrer" style={{ color: '#a5b4fc' }}>https://www.uscis.gov/n-400</a></div>
        </div>
        <h2 style={{ fontSize: '22px', fontWeight: 700, marginBottom: '16px' }}>How to Compress Photo for USCIS N-400 Citizenship</h2>
        {[
          ...
          { step: '4', title: 'Download and submit', desc: 'Your photo is compressed and ready to upload to your USCIS N-400 Citizenship application.' },
        ].map(({ step, title, desc }) => (
        ...
        <h2 style={{ fontSize: '22px', fontWeight: 700, margin: '40px 0 16px' }}>FAQ — USCIS N-400 Citizenship Photo Requirements</h2>
