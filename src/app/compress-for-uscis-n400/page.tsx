...
export default function Page() {
  ...
  const faq = [
    ...
    { q: 'How do I compress a photo for USCIS N-400 Citizenship?', a: 'Click the button above, select Exact KB Mode, enter 240 as target size and download your compressed photo.' },
