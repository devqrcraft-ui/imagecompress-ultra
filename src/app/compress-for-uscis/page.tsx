      ...
      <div style={{background:'#0f0c29',color:'#e2e8f0',fontFamily:'system-ui,sans-serif'}}>
        ...
        <section style={{maxWidth:'860px',margin:'0 auto',padding:'0 20px 28px'}}>
          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(230px,1fr))',gap:'14px'}}>
            <div style={{background:'rgba(129,140,248,0.07)',border:'1px solid rgba(129,140,248,0.18)',borderRadius:'12px',padding:'16px'}}><div style={{fontWeight:700,fontSize:'14px',color:'#c7d2fe',marginBottom:'6px'}}>Plain background</div><div style={{fontSize:'13px',lineHeight:1.6,opacity:0.8}}>Use a plain, light background and avoid heavy shadows. USCIS and consular portals require white or off-white backgrounds.</div></div>
            <div style={{background:'rgba(129,140,248,0.07)',border:'1px solid rgba(129,140,248,0.18)',borderRadius:'12px',padding:'16px'}}><div style={{fontWeight:700,fontSize:'14px',color:'#c7d2fe',marginBottom:'6px'}}>Full face visible</div><div style={{fontSize:'13px',lineHeight:1.6,opacity:0.8}}>Make sure your full face is visible with a neutral expression. No sunglasses, hats or heavy editing.</div></div>
            <div style={{background:'rgba(129,140,248,0.07)',border:'1px solid rgba(129,140,248,0.18)',borderRadius:'12px',padding:'16px'}}><div style={{fontWeight:700,fontSize:'14px',color:'#c7d2fe',marginBottom:'6px'}}>Avoid artifacts</div><div style={{fontSize:'13px',lineHeight:1.6,opacity:0.8}}>Avoid filters or over-compressed images that create visible artifacts. Use JPEG format for best portal compatibility.</div></div>
            <div style={{background:'rgba(129,140,248,0.07)',border:'1px solid rgba(129,140,248,0.18)',borderRadius:'12px',padding:'16px'}}><div style={{fontWeight:700,fontSize:'14px',color:'#c7d2fe',marginBottom:'6px'}}>Check both size and dimensions</div><div style={{fontSize:'13px',lineHeight:1.6,opacity:0.8}}>If the portal shows an error, double-check both the file size and pixel dimensions — not just one of them.</div></div>
          </div>
        </section>
        ...
        <section style={{maxWidth:'860px',margin:'0 auto',padding:'0 20px 52px'}}>
          ...
          <div style={{display:'flex',flexWrap:'wrap',gap:'10px'}}>
            <a href="/compress-for-n400" style={{padding:'8px 16px',borderRadius:'8px',background:'rgba(129,140,248,0.08)',border:'1px solid rgba(129,140,248,0.2)',color:'#a5b4fc',fontSize:'13px',fontWeight:600,textDecoration:'none',whiteSpace:'nowrap'}}>For N-400 →</a>
            <a href="/compress-for-i485" style={{padding:'8px 16px',borderRadius:'8px',background:'rgba(129,140,248,0.08)',border:'1px solid rgba(129,140,248,0.2)',color:'#a5b4fc',fontSize:'13px',fontWeight:600,textDecoration:'none',whiteSpace:'nowrap'}}>For I-485 →</a>
            <a href="/compress-for-ds160" style={{padding:'8px 16px',borderRadius:'8px',background:'rgba(129,140,248,0.08)',border:'1px solid rgba(129,140,248,0.2)',color:'#a5b4fc',fontSize:'13px',fontWeight:600,textDecoration:'none',whiteSpace:'nowrap'}}>For DS-160 →</a>
            <a href="/compress-passport-photo-usa" style={{padding:'8px 16px',borderRadius:'8px',background:'rgba(129,140,248,0.08)',border:'1px solid rgba(129,140,248,0.2)',color:'#a5b4fc',fontSize:'13px',fontWeight:600,textDecoration:'none',whiteSpace:'nowrap'}}>Compress Passport Photo →</a>
            <a href="/compress-to-200kb" style={{padding:'8px 16px',borderRadius:'8px',background:'rgba(129,140,248,0.08)',border:'1px solid rgba(129,140,248,0.2)',color:'#a5b4fc',fontSize:'13px',fontWeight:600,textDecoration:'none',whiteSpace:'nowrap'}}>Compress to 200KB →</a>
