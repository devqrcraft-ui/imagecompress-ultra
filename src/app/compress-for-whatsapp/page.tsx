...
const _faqSchema = {"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How do I send a high quality image on WhatsApp without compression?","acceptedAnswer":{"@type":"Answer","text":"WhatsApp automatically compresses images sent in chat. To avoid WhatsApp compression, send images as Documents instead of photos — tap the paperclip icon and select Document. Pre-compressing to under 1MB as JPEG also reduces the quality loss from WhatsApp's automatic re-compression."}},{"@type":"Question","name":"What size should images be for WhatsApp?","acceptedAnswer":{"@type":"Answer","text":"WhatsApp displays images up to 1600px wide. For sharing photos without WhatsApp re-compressing them heavily, keep files under 1MB as JPEG. For profile photos, WhatsApp crops to a square — use a square image at 500x500px, under 100KB."}},{"@type":"Question","name":"Why does WhatsApp reduce image quality?","acceptedAnswer":{"@type":"Answer","text":"WhatsApp automatically compresses images to reduce data usage and speed up delivery. It reduces resolution to around 1600px and applies heavy JPEG compression. Pre-compressing your image before sending gives you control over the final quality."}},{"@type":"Question","name":"Will my WhatsApp photos be uploaded to compress them?","acceptedAnswer":{"@type":"Answer","text":"No. All compression runs locally in your browser. Your photos never leave your device — safe for private and personal photos."}}]};
...
export default function CompressForWhatsappPage() {
  return (
    <main style={{ minHeight: '100vh', background: 'linear-gradient(135deg,#0f0c29,#302b63,#24243e)', color: 'white', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://compressto20kb.com"},{"@type":"ListItem","position":2,"name":"Compress Image for Whatsapp","item":"https://compressto20kb.com/compress-for-whatsapp"}]}' }} />
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 16px 24px' }}>
        ...
        <h2 style={{ fontSize: '20px', fontWeight: 800, marginBottom: '16px' }}>How to Compress Images for Whatsapp (3 Steps)</h2>
        <div style={{ display: 'grid', gap: '12px', marginBottom: '32px' }}>
          {[
            { n: '1', t: 'Upload Your Image', d: 'Drag & drop or click to select. Supports JPEG, PNG, WebP, HEIC up to 50MB.' },
            { n: '2', t: 'Set Target Size', d: 'Type your target KB — or use the Whatsapp preset for instant optimization.' },
            { n: '3', t: 'Download Compressed File', d: 'Click download. Your optimized image is ready for Whatsapp in seconds.' },
          ].map(s => (
        ...
        <h2 style={{ fontSize: '20px', fontWeight: 800, marginBottom: '16px' }}>Why Use CompressTo20KB for Whatsapp?</h2>
        ...
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', paddingTop: '24px' }}>
          <h2 style={{ fontSize: '18px', fontWeight: 800, marginBottom: '16px' }}>FAQ — Compress Images for Whatsapp</h2>
          {[
            { q: 'Is this tool really free for Whatsapp?', a: 'Yes, 100% free. No signup, no subscription, no hidden fees.' },
            ...
            { q: 'How small can I compress images for Whatsapp?', a: 'You can compress to any target size — from 5KB to 5MB. Just type your desired file size.' },
          ].map((f, i) => (
        ...
        <div style={{ textAlign: 'center', marginTop: '40px', padding: '32px', background: 'rgba(99,102,241,0.1)', borderRadius: '16px', border: '1px solid rgba(99,102,241,0.2)' }}>
          <h2 style={{ fontSize: '22px', fontWeight: 800, marginBottom: '8px' }}>Start Compressing for Whatsapp Now</h2>
