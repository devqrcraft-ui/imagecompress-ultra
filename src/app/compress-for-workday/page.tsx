...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://compressto20kb.com/compress-for-workday' },
...
export default function Page() {
  const faq = [
    { q: 'What size should my Workday HR profile photo be?', a: 'Workday profile photo: JPEG or PNG, under 5MB, square format. Used by Fortune 500 companies for HR applications.' },
    { q: 'How do I compress my photo for Workday HR?', a: 'Click the button above, upload your photo, select Exact KB Mode, enter 5120 as target size and download.' },
    { q: 'What format does Workday HR accept for profile photos?', a: 'JPEG and PNG are accepted. We recommend JPEG for smaller file sizes.' },
  ];
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg,#0f0c29,#302b63,#24243e)', color: 'white', fontFamily: 'system-ui,sans-serif' }}>

      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(_faqSchema) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://compressto20kb.com"},{"@type":"ListItem","position":2,"name":"Compress Photo for Workday HR","item":"https://compressto20kb.com/compress-for-workday"}]}' }} />
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 16px 24px' }}>
        <h1 style={{ fontSize: 'clamp(26px,4vw,42px)', fontWeight: 900, lineHeight: 1.2, marginBottom: '12px' }}>
          💼 Compress Photo for <span style={{ color: '#818cf8' }}>Workday HR</span>
        </h1>
        <p style={{ fontSize: '15px', lineHeight: 1.7, opacity: 0.7, marginBottom: '32px' }}>Workday profile photo: JPEG or PNG, under 5MB, square format. Used by Fortune 500 companies for HR applications.</p>
        ...
        <div style={{ background: 'rgba(129,140,248,0.12)', border: '1px solid rgba(129,140,248,0.35)', borderRadius: '14px', padding: '24px', marginBottom: '40px', textAlign: 'center' }}>
          <div style={{ fontSize: '15px', fontWeight: 700, marginBottom: '8px' }}>🎯 Compress for Workday HR</div>
          ...
          <a href={"/?mode=exactkb&target=5120"} style={{ display: 'inline-block', background: 'linear-gradient(135deg,#6366f1,#8b5cf6)', color: 'white', padding: '12px 28px', borderRadius: '100px', fontWeight: 800, fontSize: '14px', textDecoration: 'none' }}>
            ⚡ Compress for Workday HR
          </a>
        </div>
        <h2 style={{ fontSize: '22px', fontWeight: 700, marginBottom: '16px' }}>FAQ — Workday HR Photo</h2>
