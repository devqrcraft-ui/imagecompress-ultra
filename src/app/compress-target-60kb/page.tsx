...
export const metadata = {
  title: 'Compress Image to 60KB — Compress to 60KB | No Upload',
  description: 'Fastest way to compress image to exactly 60KB.',
  alternates: { canonical: 'https://www.compressto20kb.com/compress-target-60kb' },
};
    ...
    <>
      <div style={{background:'#0f0c29', padding:'40px 20px', textAlign:'center'}}>
        ...
        <p style={{color:'rgba(255,255,255,0.7)', maxWidth:'700px', margin:'0 auto'}}>
          Optimize your photo for Compress Image to 60KB requirements. 
      ...
      <div style={{background:'#0f0c29', padding:'40px 20px', color:'#fff', borderTop:'1px solid rgba(255,255,255,0.1)'}}>
        <div style={{maxWidth:'800px', margin:'0 auto'}}>
          <h2 style={{color:'#a5b4fc'}}>Requirements for Compress Image to 60KB</h2>
