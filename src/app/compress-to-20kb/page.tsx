...
export const metadata: Metadata = {
  ...
  description: 'Compress any image to exactly 20KB free online. Works in your browser, files never leave your device. No upload, no signup.',
  alternates: { canonical: 'https://compressto20kb.com/compress-to-20kb' },
};
const faq = { '@context':'https://schema.org','@type':'FAQPage', mainEntity:[
  {'@type':'Question',name:'How do I compress an image to exactly 20KB?',acceptedAnswer:{' @type':'Answer',text:'Upload your image, select Exact KB Mode, type 20 and click Download. Uses binary search to hit target within 1KB.'}},
  ...
  return (<>
    ...
    <article className="max-w-3xl mx-auto px-4 py-8 text-slate-100">
      ...
      <section className="mb-10">
        ...
        <p className="text-slate-300 leading-relaxed">Most tools upload your photo to a server — a serious privacy concern. CompressTo20KB processes everything in your browser. Your image is never transmitted anywhere.</p>
      </section>
      <section className="mb-10">
        <h2 className="text-2xl font-bold text-white mb-4">How to Compress to 20KB — 3 Steps</h2>
        <div className="space-y-4">
          {[{n:'1',t:'Upload Your Photo',d:'Click upload or drag your image. Accepts JPEG, PNG, WebP.'},{n:'2',t:'Select 20KB Target',d:'Click the 20 KB preset or type 20 in Custom KB field. Enable Exact KB Mode.'},{n:'3',t:'Download in Seconds',d:'Ready instantly. Everything in your browser — nothing uploaded.'}].map(s=>(
      ...
      <section>
        ...
        <div className="flex flex-wrap gap-3">
          {[['/compress-to-50kb','Compress to 50KB'],['/compress-passport-photo','Passport Photo'],['/compress-for-shopify','For Shopify']].map(([h,l])=>(
