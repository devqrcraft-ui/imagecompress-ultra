    ...
    <main style={{maxWidth:800,margin:'0 auto',padding:'48px 24px',fontFamily:'system-ui,sans-serif'}}>
      ...
      <div style={{borderTop:'2px solid #2a3a6a',marginTop:40,paddingTop:28}}>
        ...
        <div style={{display:'flex',gap:10,flexWrap:'wrap' as const}}>
          ...
          <a href="/compress-to-100kb" style={{padding:'8px 14px',background:'rgba(129,140,248,0.07)',border:'1px solid rgba(129,140,248,0.18)',borderRadius:6,fontSize:13,fontWeight:600,color:'#818cf8',textDecoration:'none'}}>Compress to 100KB</a>
        </div>
      </div>
    </main>
  )
